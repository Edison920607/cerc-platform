...
MODEL              = AFCS_MODEL1
MODULES            = AFCS_MODEL1_CodeReuseSubsystem.c AFCS_MODEL1_sf_data.c rtGetInf.c rtGetNaN.c 
MAKEFILE           = AFCS_MODEL1.mk
...
MASTER_ANCHOR_DIR  = 
START_DIR          = E:\ModePackageTest_16a\AFCS_MODEL_V2\cacheFolder
S_FUNCTIONS        =  Fader_sf.c Gain_sf.c IntegratorLimited_sf.c LagFilter_sf.c LeadLagFilter_sf.c NegativePass_sf.c PositivePass_sf.c RateLimiter_sf.c Res180_sf.c SaturationLimiter_sf.c StickGradientDeadZone_sf.c WashoutFilter_sf.c
S_FUNCTIONS_LIB    = 
SOLVER             = ode4.c
NUMST              = 2
TID01EQ            = 0
...
MEM_ALLOC          = RT_STATIC
MEXEXT             = mexw64
BUILDARGS          =  MODELLIB=AFCS_MODEL1lib.lib RELATIVE_PATH_TO_ANCHOR=.. MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING
CREATEMODEL        = 1
USERMODULES        =  
USEPARAMVALUES     = 0
MEX_OPT_FILE       = -f "C:\Program Files\MATLAB\R2016a\bin\win64\mexopts\msvc2010.xml"
COMPUTER           = PCWIN64
VISUAL_VER         = 10.0
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\AFCS_MODEL1_sfcn_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);E:\ModePackageTest_16a\AFCS_MODEL_All20210707\AFCS_MODEL_All\Sim
...
MEX_FLAGS = $(MEX_ARCH) $(MEX_OPTS) $(DEFINES_CUSTOM) $(MEX_OPT_OPTS) $(MEX_LDFLAGS) $(MEX_OPT_FILE)
