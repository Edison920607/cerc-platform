...
MODEL              = AFCS_MODEL1
MODULES            = AFCS_MODEL1_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
...
S_FUNCTIONS        =  Fader_sf.c Gain_sf.c IntegratorLimited_sf.c LagFilter_sf.c LeadLagFilter_sf.c NegativePass_sf.c PositivePass_sf.c RateLimiter_sf.c Res180_sf.c SaturationLimiter_sf.c StickGradientDeadZone_sf.c WashoutFilter_sf.c sf_sfun.c
S_FUNCTIONS_LIB    = 
SOLVER             = 
NUMST              = 2
TID01EQ            = 1
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\slprj\accel\AFCS_MODEL1
