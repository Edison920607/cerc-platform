...
def callback(Path):
    ...
    p_dist = [dist for dist in Path.data]
    # print(p_dist)
...
# subcribe = node_.Subscribe('FW_0', '/cjq/FW_0/path', Float32Array_pb2.Float32Array, callback)
subcribe = node_.Subscribe(f'{envid}', 'FW01_0', '/' + f'{envid}' + '/FW01_0/path', Float32Array_pb2.Float32Array,
                           callback)
