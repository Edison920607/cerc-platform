...
publish_ = node_.Advertise(f'{envid}', 'FW01_0', '/' + f'{envid}' + '/FW01_0/transform',
...
def main(args):
    ...
    while True:
        message, client = send.recvfrom(1024)
        memmove(addressof(datasend), (message), sizeof(DataSend))
        publish_s.sent_UE4(datasend.member_0, datasend.member_1, datasend.member_2, datasend.member_3,
                           datasend.member_4, datasend.member_5)
