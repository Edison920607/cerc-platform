...
def main(args):
    ...
    publish_s.sent_path(197, -415, 50, 1.1512)
    publish_s.sent_gimbal(0, -22, 160)
    ...
    publish_s.sent_path(197, -415, 30, 1.1512)
    publish_s.sent_gimbal(0, -41, 80)
    publish1_s.sent_path1(-90, -137, 30, -1.9182)
    publish1_s.sent_gimbal1(0, -30, - 109)
    publish2_s.sent_path2(-506, -167, 30, 1.1683)
    publish2_s.sent_gimbal2(0, -41, 70)
    time.sleep(35)  ### 目标点
