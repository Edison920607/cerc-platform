...
def callback0(aPose):
    ...
    datareceive0.member_0 = aPose.pose.position.x
    datareceive0.member_1 = aPose.pose.position.y
    datareceive0.member_2 = -aPose.pose.position.z

    x = aPose.pose.orientation.x
    y = aPose.pose.orientation.y
    z = aPose.pose.orientation.z
    w = aPose.pose.orientation.w
...
def callback1(bPose):
    ...
    datareceive1.member_0 = bPose.pose.position.x
    datareceive1.member_1 = bPose.pose.position.y
    datareceive1.member_2 = -bPose.pose.position.z

    x = bPose.pose.orientation.x
    y = bPose.pose.orientation.y
    z = bPose.pose.orientation.z
    w = bPose.pose.orientation.w
...
def callback2(cPose):
    ...
    datareceive2.member_0 = cPose.pose.position.x
    datareceive2.member_1 = cPose.pose.position.y
    datareceive2.member_2 = -cPose.pose.position.z

    x = cPose.pose.orientation.x
    y = cPose.pose.orientation.y
    z = cPose.pose.orientation.z
    w = cPose.pose.orientation.w
...
# subcribe0 = node_.Subscribe(Config['envid'], 'M300_0', '/FK/M300_0/pose', Pose_pb2.Pose, callback0)
# subcribe1 = node_.Subscribe(Config['envid'], 'M300_1', '/FK/M300_1/pose', Pose_pb2.Pose, callback1)
# subcribe2 = node_.Subscribe(Config['envid'], 'M300_2', '/FK/M300_2/pose', Pose_pb2.Pose, callback2)

subcribeJiaoHu0 = node_.Subscribe('FK', 'M300_0', '/FK/M300_0/cmd_goal', PoseStamped_pb2.PoseStamped, callback0)
subcribeJiaoHu1 = node_.Subscribe('FK', 'M300_1', '/FK/M300_1/cmd_goal', PoseStamped_pb2.PoseStamped, callback1)
subcribeJiaoHu2 = node_.Subscribe('FK', 'M300_2', '/FK/M300_2/cmd_goal', PoseStamped_pb2.PoseStamped, callback2)
