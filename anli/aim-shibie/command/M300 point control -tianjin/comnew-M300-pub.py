...
publish0_ = node_.Advertise('M300_0', '/Case2/M300_0/transform',CustomTransform_pb2.CustomTransform)
publish1_ = node_.Advertise('M300_1', '/Case2/M300_1/transform',CustomTransform_pb2.CustomTransform)
publish2_ = node_.Advertise('M300_2', '/Case2/M300_2/transform',CustomTransform_pb2.CustomTransform)
...
class Publish:
    ...
    def pub0(self):
        ...
        while True: 
            ...
            self.sent_UE0(datasend0.member_0, datasend0.member_1, datasend0.member_2, datasend0.member_3, datasend0.member_4, datasend0.member_5)
    ...
    def pub1(self):
        ...
        while True: 
            ...
            self.sent_UE1(datasend1.member_0, datasend1.member_1, datasend1.member_2, datasend1.member_3, datasend1.member_4, datasend1.member_5)
    ...
    def pub2(self):
        ...
        while True: 
            ...
            self.sent_UE2(datasend2.member_0, datasend2.member_1, datasend2.member_2, datasend2.member_3, datasend2.member_4, datasend2.member_5)
...
def main(args):
    ...
    while True: 
            ...
            memmove(addressof(datasend1), (message1), sizeof(DataSend1))
            memmove(addressof(datasend2), (message2), sizeof(DataSend2))
            publish_s.sent_UE0(datasend0.member_0, datasend0.member_1, datasend0.member_2, datasend0.member_3, datasend0.member_4, datasend0.member_5)
            publish_s.sent_UE1(datasend1.member_0, datasend1.member_1, datasend1.member_2, datasend1.member_3, datasend1.member_4, datasend1.member_5)
            publish_s.sent_UE2(datasend2.member_0, datasend2.member_1, datasend2.member_2, datasend2.member_3, datasend2.member_4, datasend2.member_5)
