...
publish = node_.Advertise('FK', 'M300_0', '/FK/M300_0/pose', Pose_pb2.Pose)
publish1 = node_.Advertise('FK', 'M300_0', '/FK/M300_0/gimbal_angle_cmd', Vector3_pb2.Vector3)
publish2 = node_.Advertise('FK', 'M300_1', '/FK/M300_1/pose', Pose_pb2.Pose)
publish3 = node_.Advertise('FK', 'M300_1', '/FK/M300_1/gimbal_angle_cmd', Vector3_pb2.Vector3)
publish4 = node_.Advertise('FK', 'M300_2', '/FK/M300_2/pose', Pose_pb2.Pose)
publish5 = node_.Advertise('FK', 'M300_2', '/FK/M300_2/gimbal_angle_cmd', Vector3_pb2.Vector3)
# s_time = 0
publish_cmd_go_M300_1 = node_.Advertise('FK', 'M300_1', '/FK/M300_1/cmd_goal', PoseStamped_pb2.PoseStamped)
publish_cmd_go_M300_2 = node_.Advertise('FK', 'M300_2', '/FK/M300_2/cmd_goal', PoseStamped_pb2.PoseStamped)
publish_cmd_go_M300_0 = node_.Advertise('FK', 'M300_0', '/FK/M300_0/cmd_goal', PoseStamped_pb2.PoseStamped)
...
class CMD_Pubilsh:
    def sent_pathsent_path(self, x, y, z, yawrate):
        cmd_go_pose = PoseStamped_pb2.PoseStamped()
        cmd_go_pose.position.x = x
        cmd_go_pose.position.y = y
        cmd_go_pose.position.z = z
        cmd_go_pose.orientation.x = yawrate
        publish_cmd_go_M300_1.Publish(cmd_go_pose)
...
class Publish:
    ...
    def sent_goal_path(self, x, y, z, roll, pitch, yaw):
        pose = PoseStamped_pb2.PoseStamped()
        huancun = get_quaternion_from_euler(roll, pitch, yaw)

        pose.position.x = x
        pose.position.y = -y
        pose.position.z = -z
        pose.orientation.x = huancun[0]
        publish.Publish(pose)
...
def main(args):
    ...
    publish_s.sent_path(0, 0, 8, 0)
    publish_s.sent_gimbal(0, -35, 0)

    publish1_s.sent_path1(0, 0, 8, 0)
    publish1_s.sent_gimbal1(0, -33, 0)

    publish2_s.sent_path2(0, 0, 8, 0)
    ...
    '''
    '''
    publish_s.sent_goal_path(197, -415, 80, 2.7512)
    publish_s.sent_gimbal(0, -82, 160)
    publish1_s.sent_path1(-90, -137, 80, -1.9182)
    publish1_s.sent_goal_path(0, -82, -109)
    publish2_s.sent_path2(-506, -167, 80, 1.1683)
    publish2_s.sent_goal_path(0, -82, 70)
    time.sleep(35)  ### 目标点
    '''
    ...
    while True: 
        ...
        publish2_s.sent_path2(-430, -350, -60, 1.56232 )GIT
        publish2_s.sent_gimbal2(0,-31,0) 
