...
% THR_HOVER = 0.609;
%% Initial condition
ModelInit_PosE0 = [0, 0, 0];
ModelInit_PosE1 = [0, 0, 0];
ModelInit_PosE2 = [0, 0, 0];
ModelInit_VelB = [0, 0, 0];
ModelInit_AngEuler = [0, 0, 0];
ModelInit_RateB = [0, 0, 0];
% ModelInit_Rads = 557.142;

ModelInit_Rads = sqrt((ModelParam_uavMass*ModelParam_envGravityAcc)/(4*ModelParam_rotorCt));
THR_HOVER = (ModelInit_Rads-ModelParam_motorWb)/ModelParam_motorCr;
...
MAX_CONTROL_VELOCITY_XY = 17.6;
MAX_CONTROL_VELOCITY_Z = 5;
% throttle amplitude
MAX_MAN_THR = 0.9;
MIN_MAN_THR = 0.05;
