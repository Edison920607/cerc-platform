...
def main(args):
    ...
    while 1:
        if C_C.Collector_data.env == f"{envid}" and (C_C.Collector_data.flag == 0 or C_C.Collector_data.flag == 2):
            ...
            # time.sleep(6)
            # time.sleep(5)
            os.system('D:\\jingshen\\Dy\\aim-shibie\\fuheyibizhangjiaohu.bat')
            # t1.start()
            # t2.start()
            # t3.start()
            # t4.start()
            ...
            # os.system('python ".\\WingFly yonghu\\FW-pubnew.py"')
            # time.sleep(5)
            # os.system('python .\\WingFly_tianjin\\comnew-FW-sub.py')
            # time.sleep(5)
            # os.system('python .\\WingFly_tianjin\\comnew-FW-pub.py')
            # time.sleep(5)
            # os.system('python .\\command\\M300 point control\\comnew-M300-sub.py')
            # time.sleep(5)
            # os.system('python .\\command\\M300 point control\\comnew-M300-pub.py')
            time.sleep(8)
